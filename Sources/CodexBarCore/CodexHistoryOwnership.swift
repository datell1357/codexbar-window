...
public enum CodexHistoryPersistedOwner: Equatable, Sendable {
...
public enum CodexHistoryOwnership {
    ...
    public static func belongsToTargetContinuity(
    ...
    public static func hasStrictSingleAccountContinuity(
    ...
    public static func isCanonicalProviderAccountKey(_ rawKey: String) -> Bool {
