...
public struct HistoricalUsageRecord: Codable, Sendable {
    public let v: Int
...
public struct HistoricalWeekProfile: Sendable {
    public let resetsAt: Date
    public let windowMinutes: Int
...
public struct CodexHistoricalDataset: Sendable {
...
public actor HistoricalUsageHistoryStore {
    ...
    #if DEBUG
    public nonisolated static func _dayStartForTesting(_ key: String) -> Date? {
        self.dayStart(for: key)
    }

    public nonisolated static func _creditsUsedForTesting(
...
public enum CodexHistoricalPaceEvaluator {
    public static let minimumCompleteWeeksForHistorical = 3
    public static let minimumWeeksForRisk = 5
    private static let recencyTauWeeks: Double = 3
    private static let epsilon: Double = 1e-9
    private static let resetBucketSeconds: TimeInterval = 5 * 60

    public static func evaluate(window: RateWindow, now: Date, dataset: CodexHistoricalDataset?) -> UsagePace? {
