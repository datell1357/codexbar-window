#if os(Windows)
// Ported from the original Foundation spend model; native presentation is separate.
import CodexBarCore
import Foundation

// swiftlint:disable:next type_body_length
struct WindowsSpendDashboardModel: Equatable, Sendable {
    ...
    struct ProviderInput: Sendable {
        ...
        init(
            ...
            sourceKind: WindowsSpendDashboardModel.SourceKind = .native)
        {
        ...
        let sourceKind: WindowsSpendDashboardModel.SourceKind
    }
...
extension WindowsSpendDashboardModel.CurrencyGroup {
